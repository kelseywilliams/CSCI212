...
test:       .asciz  "%u\n"
test2:      .asciz  "%d\n"
hand1:      .asciz  "Here is your Hand:\n"
hand2:      .asciz  "Here is your new Hand:\n"
spacing:    .asciz  "\n"
...
main:
	...
	@@@ id annoyance  == add in your last three digits of your pal id by hand (only if higher than 250)
	mov r3, #200
	add r3, r3, #200
	add r3, r3, #200
	add r3, r3, #16
